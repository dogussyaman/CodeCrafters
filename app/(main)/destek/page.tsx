        ...
        role === "developer"
            ...
            : role === "hr"
              ...
              : (role as string) === "company_admin"
                ...
                : undefined
    const resolvedTicketsHref = ticketsPageHref
            ...
            <section className="pb-20">
                <div className="container mx-auto px-4">
                    <div className="max-w-2xl mx-auto">
                            ...
                            <CardContent>
                                {!loading && (
                                    <CreateTicketForm
                                        ...
                                        ticketsPageHref={resolvedTicketsHref}
                                    />
                                )}
                                {loading && (
                        ...
                        {user && resolvedTicketsHref && (
                            <p className="text-center text-sm text-muted-foreground mt-4">
                                <Link href={resolvedTicketsHref} className="text-primary hover:underline">
